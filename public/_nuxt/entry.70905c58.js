...
const bi = t => D0(t)
    ...
    return t.client ? e = t.client : e = L1(t.endpoint, {
        fetch: async (s, o) => {
            let a;
            return typeof globalThis.fetch == "function" ? a = globalThis.fetch : a = (await mo( () => import("./browser.3f5b2d8a.js").then(u => u.b), ["./browser.3f5b2d8a.js", "./_commonjsHelpers.042e6b4d.js"], import.meta.url)).default,
                await a(s, o)
        }
        ,
        ...t.clientConfig
