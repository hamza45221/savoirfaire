...
(function(P) {
        (function() {
                ...
                S.prototype = {
                    ...
                    _setupCodecs: function() {
                        ...
                        var n = t.canPlayType("audio/mpeg;").replace(/^no$/, "")
                            ...
                            , o = r.indexOf("Safari") !== -1 && r.indexOf("Chrome") === -1
                            , _ = r.match(/Version\/(.*?) /)
                            ...
                            var t = function(n) {
                                ...
                                for (var i = 0; i < e._howls.length; i++)
                                    if (!e._howls[i]._webAudio)
                                        for (var u = e._howls[i]._getSoundIds(), o = 0; o < u.length; o++) {
                    ...
                    _autoResume: function() {
                        var e = this;
                        if (!(!e.ctx || typeof e.ctx.resume > "u" || !a.usingWebAudio))
                ...
                l.prototype = {
                    init: function(e) {
                        ...
                        typeof a.ctx < "u" && a.ctx && a.autoUnlock && a._unlockAudio(),
                            a._howls.push(t),
                    ...
                    play: function(e, t) {
                        ...
                        if (typeof e == "number")
                            ...
                            if (typeof e > "u" && (e = "__default",
                                !n._playLock)) {
                                for (var i = 0, u = 0; u < n._sounds.length; u++)
                                    n._sounds[u]._paused && !n._sounds[u]._ended && (i++,
                                        r = n._sounds[u]._id);
                                i === 1 ? e = null : r = null
                            }
                        }
                        ...
                        var h = Math.max(0, o._seek > 0 ? o._seek : n._sprite[e][0] / 1e3)
                            , b = Math.max(0, (n._sprite[e][0] + n._sprite[e][1]) / 1e3 - h)
                        ...
                        if (n._webAudio) {
                            var R = function() {
                                ...
                                A.gain.setValueAtTime(B, a.ctx.currentTime),
                                    o._playStart = a.ctx.currentTime,
                                    typeof A.bufferSource.start > "u" ? o._loop ? A.bufferSource.noteGrainOn(0, h, 86400) : A.bufferSource.noteGrainOn(0, h, b) : o._loop ? A.bufferSource.start(0, h, 86400) : A.bufferSource.start(0, h, b),
                                O !== 1 / 0 && (n._endTimers[o._id] = setTimeout(n._ended.bind(n, o), O)),
                                t || setTimeout(function() {
                                    n._emit("play", o._id),
                                        n._loadQueue()
                                }, 0)
                            };
                            a.state === "running" && a.ctx.state !== "interrupted" ? R() : (n._playLock = !0,
                                n.once("resume", R),
                                n._clearTimer(o._id))
                        } else {
                            var W = function() {
                                A.currentTime = h,
                                    A.muted = o._muted || n._muted || a._muted || A.muted,
                                    A.volume = o._volume * a.volume(),
                                    A.playbackRate = o._rate;
                                try {
                                    var B = A.play();
                                    if (B && typeof Promise < "u" && (B instanceof Promise || typeof B.then == "function") ? (n._playLock = !0,
                                        g(),
                                        B.then(function() {
                                            n._playLock = !1,
                                                A._unlocked = !0,
                            ...
                            A.src === "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA" && (A.src = n._src,
                                A.load());
                            ...
                            if (A.readyState >= 3 || Y)
                                ...
                                var $ = function() {
                                    n._state = "loaded",
                                        W(),
                                        A.removeEventListener(a._canPlayEvent, $, !1)
                                };
                                A.addEventListener(a._canPlayEvent, $, !1),
                                    n._clearTimer(o._id)
                            }
                        }
                        return o._id
                            ...
                            if (i && !i._paused && (i._seek = t.seek(n[r]),
                                ...
                                if (t._webAudio) {
                                    if (!i._node.bufferSource)
                                        continue;
                                    typeof i._node.bufferSource.stop > "u" ? i._node.bufferSource.noteOff(0) : i._node.bufferSource.stop(0),
                    ...
                    stop: function(e, t) {
                        ...
                        for (var r = n._getSoundIds(e), i = 0; i < r.length; i++) {
                            ...
                            u && (u._seek = u._start || 0,
                                u._rateSeek = 0,
                                u._paused = !0,
                                u._ended = !0,
                                n._stopFade(r[i]),
                            u._node && (n._webAudio ? u._node.bufferSource && (typeof u._node.bufferSource.stop > "u" ? u._node.bufferSource.noteOff(0) : u._node.bufferSource.stop(0),
                                n._cleanBuffer(u._node)) : (!isNaN(u._node.duration) || u._node.duration === 1 / 0) && (u._node.currentTime = u._start || 0,
                                u._node.pause(),
                            u._node.duration === 1 / 0 && n._clearSound(u._node))),
                            t || n._emit("stop", u._id))
                        }
                        return n
                    },
                    mute: function(e, t) {
                        ...
                        for (var r = n._getSoundIds(t), i = 0; i < r.length; i++) {
                            ...
                            u._interval && n._stopFade(u._id),
                                n._webAudio && u._node ? u._node.gain.setValueAtTime(e ? 0 : u._volume, a.ctx.currentTime) : u._node && (u._node.muted = a._muted ? !0 : e),
                                n._emit("mute", u._id))
                        }
                        return n
                    },
                        ...
                        if (typeof n < "u" && n >= 0 && n <= 1) {
                            if (e._state !== "loaded" || e._playLock)
                                return e._queue.push({
                                    ...
                                    e;
                            typeof r > "u" && (e._volume = n),
                                r = e._getSoundIds(r);
                            for (var _ = 0; _ < r.length; _++)
                                o = e._soundById(r[_]),
                                o && (o._volume = n,
                                t[2] || e._stopFade(r[_]),
                                    e._webAudio && o._node && !o._muted ? o._node.gain.setValueAtTime(n, a.ctx.currentTime) : o._node && !o._muted && (o._node.volume = n * a.volume()),
                                    e._emit("volume", o._id))
                        } else
                            return o = r ? e._soundById(r) : e._sounds[0],
                                o ? o._volume : 0;
                        return e
                    },
                    fade: function(e, t, n, r) {
                        ...
                        for (var u = i._getSoundIds(r), o = 0; o < u.length; o++) {
                            ...
                            if (_) {
                                if (r || i._stopFade(u[o]),
                                i._webAudio && !_._muted) {
                                    var h = a.ctx.currentTime
                                        , b = h + n / 1e3;
                                    _._volume = e,
                                        _._node.gain.setValueAtTime(e, h),
                                        _._node.gain.linearRampToValueAtTime(t, b)
                                }
                        ...
                        e._fadeTo = n,
                            e._interval = setInterval(function() {
                                ...
                                E = Date.now(),
                                    ...
                                    h < 0 ? _ = Math.max(n, _) : _ = Math.min(n, _),
                                    o._webAudio ? e._volume = _ : o.volume(_, e._id, !0),
                                u && (o._volume = _),
                                (n < t && _ <= n || n > t && _ >= n) && (clearInterval(e._interval),
                                    e._interval = null,
                                    e._fadeTo = null,
                                    o.volume(n, e._id),
                                    o._emit("fade", e._id))
                    ...
                    loop: function() {
                        ...
                        if (t.length === 1)
                            if (typeof t[0] == "boolean")
                                ...
                                return i = e._soundById(parseInt(t[0], 10)),
                                    i ? i._loop : !1;
                        else
                            t.length === 2 && (n = t[0],
                                r = parseInt(t[1], 10));
                        for (var u = e._getSoundIds(r), o = 0; o < u.length; o++)
                            i = e._soundById(u[o]),
                            i && (i._loop = n,
                            e._webAudio && i._node && i._node.bufferSource && (i._node.bufferSource.loop = n,
                            n && (i._node.bufferSource.loopStart = i._start || 0,
                                i._node.bufferSource.loopEnd = i._stop,
                            e.playing(u[o]) && (e.pause(u[o], !0),
                                e.play(u[o], !0)))));
                        return e
                    },
                    rate: function() {
                        ...
                        if (typeof n == "number") {
                            if (e._state !== "loaded" || e._playLock)
                                return e._queue.push({
                                    ...
                                    e;
                            typeof r > "u" && (e._rate = n),
                                r = e._getSoundIds(r);
                            for (var _ = 0; _ < r.length; _++)
                                if (o = e._soundById(r[_]),
                                    o) {
                                    e.playing(r[_]) && (o._rateSeek = e.seek(r[_]),
                                        o._playStart = e._webAudio ? a.ctx.currentTime : o._playStart),
                                        o._rate = n,
                                        e._webAudio && o._node && o._node.bufferSource ? o._node.bufferSource.playbackRate.setValueAtTime(n, a.ctx.currentTime) : o._node && (o._node.playbackRate = n);
                                    var h = e.seek(r[_])
                                        , b = (e._sprite[o._sprite][0] + e._sprite[o._sprite][1]) / 1e3 - h
                                        , O = b * 1e3 / Math.abs(o._rate);
                                    (e._endTimers[r[_]] || !o._paused) && (e._clearTimer(r[_]),
                                        e._endTimers[r[_]] = setTimeout(e._ended.bind(e, o), O)),
                                        e._emit("rate", o._id)
                                }
                        } else
                            return o = e._soundById(r),
                                o ? o._rate : e._rate;
                        return e
                    },
                    seek: function() {
                        var e = this, t = arguments, n, r;
                        if (t.length === 0)
                            e._sounds.length && (r = e._sounds[0]._id);
                        else if (t.length === 1) {
                            var i = e._getSoundIds()
                                , u = i.indexOf(t[0]);
                            u >= 0 ? r = parseInt(t[0], 10) : e._sounds.length && (r = e._sounds[0]._id,
                                n = parseFloat(t[0]))
                        } else
                            t.length === 2 && (n = parseFloat(t[0]),
                                r = parseInt(t[1], 10));
                        ...
                        if (o)
                            if (typeof n == "number" && n >= 0) {
                                ...
                                _ && e.pause(r, !0),
                                    ...
                                    o._ended = !1,
                                    e._clearTimer(r),
                                !e._webAudio && o._node && !isNaN(o._node.duration) && (o._node.currentTime = n);
                                var h = function() {
                                    _ && e.play(r, !0),
                                        e._emit("seek", r)
                                };
                    ...
                    on: function(e, t, n, r) {
                        var i = this
                            , u = i["_on" + e];
                        return typeof t == "function" && u.push(r ? {
                            id: n,
                            fn: t,
                            once: r
                        } : {
                    ...
                    off: function(e, t, n) {
                        ...
                        t || n)
                            ...
                            for (u = 0; u < _.length; u++)
                                _[u].indexOf("_on") === 0 && Array.isArray(r[_[u]]) && (r[_[u]] = [])
                        }
                        return r
                    },
                    once: function(e, t, n) {
                    ...
                    _emit: function(e, t, n) {
                        for (var r = this, i = r["_on" + e], u = i.length - 1; u >= 0; u--)
                            (!i[u].id || i[u].id === t || e === "load") && (setTimeout(function(o) {
                                o.call(this, t, n)
                            }
                                .bind(r, i[u].fn), 0),
                    ...
                    _refreshBuffer: function(e) {
                        ...
                        return e._node.bufferSource = a.ctx.createBufferSource(),
                            e._node.bufferSource.buffer = p[t._src],
                ...
                s.prototype = {
                    ...
                    create: function() {
                        ...
                        return t._webAudio ? (e._node = typeof a.ctx.createGain > "u" ? a.ctx.createGainNode() : a.ctx.createGain(),
                ...
                var p = {}
                    ...
                    if (/^data:[^;]+;base64,/.test(t)) {
                        ...
                        e._xhr.headers && Object.keys(e._xhr.headers).forEach(function(o) {
                    ...
                    var n = function() {
                        ...
                        , r = function(i) {
                        i && t._sounds.length > 0 ? (p[t._src] = i,
                            c(t, i)) : n()
                    };
                    ...
                    if (a.usingWebAudio) {
                        ...
                        a.usingWebAudio && (a.masterGain = typeof a.ctx.createGain > "u" ? a.ctx.createGainNode() : a.ctx.createGain(),
                ...
                P.Howler = a,
                    P.Howl = l,
                    typeof Z < "u" ? (Z.HowlerGlobal = S,
                        Z.Howler = a,
                        Z.Howl = l,
                        Z.Sound = s) : typeof window < "u" && (window.HowlerGlobal = S,
                        window.Howler = a,
                        window.Howl = l,
                        window.Sound = s)
            }
     ...
     */
        (function() {
                HowlerGlobal.prototype._pos = [0, 0, 0],
                    ...
                    HowlerGlobal.prototype.stereo = function(a) {
                        ...
                        if (!l.ctx || !l.ctx.listener)
                            return l;
                        for (var s = l._howls.length - 1; s >= 0; s--)
                            l._howls[s].stereo(a);
                        return l
                    }
                    ,
                    HowlerGlobal.prototype.pos = function(a, l, s) {
                        ...
                        if (!p.ctx || !p.ctx.listener)
                            return p;
                        if (l = typeof l != "number" ? p._pos[1] : l,
                            s = typeof s != "number" ? p._pos[2] : s,
                        typeof a == "number")
                            p._pos = [a, l, s],
                                typeof p.ctx.listener.positionX < "u" ? (p.ctx.listener.positionX.setTargetAtTime(p._pos[0], Howler.ctx.currentTime, .1),
                                    p.ctx.listener.positionY.setTargetAtTime(p._pos[1], Howler.ctx.currentTime, .1),
                                    p.ctx.listener.positionZ.setTargetAtTime(p._pos[2], Howler.ctx.currentTime, .1)) : p.ctx.listener.setPosition(p._pos[0], p._pos[1], p._pos[2]);
                        else
                            return p._pos;
                        return p
                    }
                    ...
                    HowlerGlobal.prototype.orientation = function(a, l, s, p, f, T) {
                        ...
                        if (l = typeof l != "number" ? c[1] : l,
                            s = typeof s != "number" ? c[2] : s,
                            p = typeof p != "number" ? c[3] : p,
                            f = typeof f != "number" ? c[4] : f,
                            T = typeof T != "number" ? c[5] : T,
                        typeof a == "number")
                            m._orientation = [a, l, s, p, f, T],
                                typeof m.ctx.listener.forwardX < "u" ? (m.ctx.listener.forwardX.setTargetAtTime(a, Howler.ctx.currentTime, .1),
                                    m.ctx.listener.forwardY.setTargetAtTime(l, Howler.ctx.currentTime, .1),
                                    m.ctx.listener.forwardZ.setTargetAtTime(s, Howler.ctx.currentTime, .1),
                                    m.ctx.listener.upX.setTargetAtTime(p, Howler.ctx.currentTime, .1),
                                    m.ctx.listener.upY.setTargetAtTime(f, Howler.ctx.currentTime, .1),
                                    m.ctx.listener.upZ.setTargetAtTime(T, Howler.ctx.currentTime, .1)) : m.ctx.listener.setOrientation(a, l, s, p, f, T);
                        else
                            return c;
                        return m
                    }
                    ...
                    Howl.prototype.init = function(a) {
                        return function(l) {
                            var s = this;
                            return s._orientation = l.orientation || [1, 0, 0],
                                s._stereo = l.stereo || null,
                                s._pos = l.pos || null,
                                s._pannerAttr = {
                                ...
                                s._onstereo = l.onstereo ? [{
                                    fn: l.onstereo
                                }] : [],
                                s._onpos = l.onpos ? [{
                                    fn: l.onpos
                                }] : [],
                                s._onorientation = l.onorientation ? [{
                                    fn: l.onorientation
                                }] : [],
                                a.call(this, l)
                        }
                    }(Howl.prototype.init),
                    Howl.prototype.stereo = function(a, l) {
                        var s = this;
                        if (!s._webAudio)
                            return s;
                        if (s._state !== "loaded")
                        ...
                        for (var f = s._getSoundIds(l), T = 0; T < f.length; T++) {
                            ...
                            if (m)
                                if (typeof a == "number")
                                    m._stereo = a,
                                        m._pos = [a, 0, 0],
                                    m._node && (m._pannerAttr.panningModel = "equalpower",
                                    (!m._panner || !m._panner.pan) && S(m, p),
                                        p === "spatial" ? typeof m._panner.positionX < "u" ? (m._panner.positionX.setValueAtTime(a, Howler.ctx.currentTime),
                                            m._panner.positionY.setValueAtTime(0, Howler.ctx.currentTime),
                                            m._panner.positionZ.setValueAtTime(0, Howler.ctx.currentTime)) : m._panner.setPosition(a, 0, 0) : m._panner.pan.setValueAtTime(a, Howler.ctx.currentTime)),
                    ...
                    Howl.prototype.pos = function(a, l, s, p) {
                        ...
                        for (var T = f._getSoundIds(p), m = 0; m < T.length; m++) {
                            ...
                            if (c)
                                if (typeof a == "number")
                                    c._pos = [a, l, s],
                                    c._node && ((!c._panner || c._panner.pan) && S(c, "spatial"),
                                        typeof c._panner.positionX < "u" ? (c._panner.positionX.setValueAtTime(a, Howler.ctx.currentTime),
                                            c._panner.positionY.setValueAtTime(l, Howler.ctx.currentTime),
                                            c._panner.positionZ.setValueAtTime(s, Howler.ctx.currentTime)) : c._panner.setPosition(a, l, s)),
                                        f._emit("pos", c._id);
                                else
                                    return c._pos
                        }
                    ...
                    Howl.prototype.orientation = function(a, l, s, p) {
                        ...
                        if (f._state !== "loaded")
                            return f._queue.push({
                                ...
                                f;
                        if (l = typeof l != "number" ? f._orientation[1] : l,
                            s = typeof s != "number" ? f._orientation[2] : s,
                        typeof p > "u")
                            if (typeof a == "number")
                                f._orientation = [a, l, s];
                            else
                        ...
                        for (var T = f._getSoundIds(p), m = 0; m < T.length; m++) {
                            ...
                            if (c)
                                if (typeof a == "number")
                                    c._orientation = [a, l, s],
                                    c._node && (c._panner || (c._pos || (c._pos = f._pos || [0, 0, -.5]),
                                        S(c, "spatial")),
                                        typeof c._panner.orientationX < "u" ? (c._panner.orientationX.setValueAtTime(a, Howler.ctx.currentTime),
                                            c._panner.orientationY.setValueAtTime(l, Howler.ctx.currentTime),
                                            c._panner.orientationZ.setValueAtTime(s, Howler.ctx.currentTime)) : c._panner.setOrientation(a, l, s)),
                    ...
                    Howl.prototype.pannerAttr = function() {
                        ...
                        if (l.length === 1)
                            if (typeof l[0] == "object")
                                s = l[0],
                                typeof p > "u" && (s.pannerAttr || (s.pannerAttr = {
                                ...
                                return f = a._soundById(parseInt(l[0], 10)),
                                    f ? f._pannerAttr : a._pannerAttr;
                        else
                            l.length === 2 && (s = l[0],
                                p = parseInt(l[1], 10));
                        for (var T = a._getSoundIds(p), m = 0; m < T.length; m++)
                            if (f = a._soundById(T[m]),
                                f) {
                                var c = f._pannerAttr;
                                c = {
                                ...
                                var I = f._panner;
                                I || (f._pos || (f._pos = a._pos || [0, 0, -.5]),
                                    S(f, "spatial"),
                                    I = f._panner),
                                    I.coneInnerAngle = c.coneInnerAngle,
                                    I.coneOuterAngle = c.coneOuterAngle,
                                    I.coneOuterGain = c.coneOuterGain,
                                    I.distanceModel = c.distanceModel,
                                    I.maxDistance = c.maxDistance,
                                    I.refDistance = c.refDistance,
                                    I.rolloffFactor = c.rolloffFactor,
                                    I.panningModel = c.panningModel
                            }
                        return a
                    }
                    ,
                    Sound.prototype.init = function(a) {
                        return function() {
                            var l = this
                                , s = l._parent;
                            l._orientation = s._orientation,
                                l._stereo = s._stereo,
                                l._pos = s._pos,
                                l._pannerAttr = s._pannerAttr,
                                a.call(this),
                                l._stereo ? s.stereo(l._stereo) : l._pos && s.pos(l._pos[0], l._pos[1], l._pos[2], l._id)
                        }
                    ...
                    Sound.prototype.reset = function(a) {
                        return function() {
                            var l = this
                                , s = l._parent;
                            return l._orientation = s._orientation,
                                l._stereo = s._stereo,
                                l._pos = s._pos,
                                l._pannerAttr = s._pannerAttr,
                                l._stereo ? s.stereo(l._stereo) : l._pos ? s.pos(l._pos[0], l._pos[1], l._pos[2], l._id) : l._panner && (l._panner.disconnect(0),
                                    l._panner = void 0,
                                    s._refreshBuffer(l)),
                                a.call(this)
                        }
                ...
                var S = function(a, l) {
                    l = l || "spatial",
                        l === "spatial" ? (a._panner = Howler.ctx.createPanner(),
                            ...
                            typeof a._panner.positionX < "u" ? (a._panner.positionX.setValueAtTime(a._pos[0], Howler.ctx.currentTime),
                                a._panner.positionY.setValueAtTime(a._pos[1], Howler.ctx.currentTime),
                                a._panner.positionZ.setValueAtTime(a._pos[2], Howler.ctx.currentTime)) : a._panner.setPosition(a._pos[0], a._pos[1], a._pos[2]),
                            typeof a._panner.orientationX < "u" ? (a._panner.orientationX.setValueAtTime(a._orientation[0], Howler.ctx.currentTime),
                                a._panner.orientationY.setValueAtTime(a._orientation[1], Howler.ctx.currentTime),
                                a._panner.orientationZ.setValueAtTime(a._orientation[2], Howler.ctx.currentTime)) : a._panner.setOrientation(a._orientation[0], a._orientation[1], a._orientation[2])) : (a._panner = Howler.ctx.createStereoPanner(),
...
const Fe = P => (Ie("data-v-5ae880a5"),
    P = P(),
    Me(),
    P)
    , De = Fe( () => V("img", {
    class: "index_track--shape",
    src: qe,
    alt: "Tracker Rounded Shape"
}, null, -1))
    , Ge = {
    __name: "index",
    async setup(P) {
        ...
        const {client: G} = he()
            , {data: g} = ([S,a] = ye( () => Se("homepage", () => G.getSingle("homepage"))),
            S = await S,
            a(),
            S);
        ge( () => D.loaded, y => {
        ...
        ie(async () => {
                ...
                (k = window == null ? void 0 : window.lenis) == null || k.stop(),
                    Le(),
                    c.value = m.value.offsetHeight,
                window.scene || (window.scene = new He(document.querySelector("canvas")),
                    window.scene.initializeTextMetrics(),
                    await window.scene.setup()),
                    w.set(".home__logo", {
                        zIndex: 14
                    }),
                    b = new z.Howl({
                    ...
                    await we(),
                D.loaded === !0 && R(),
                    o = (F = (q = (L = g == null ? void 0 : g.value) == null ? void 0 : L.data) == null ? void 0 : q.desktop_images) == null ? void 0 : F.length,
                    _ = (X = (K = (Q = g == null ? void 0 : g.value) == null ? void 0 : Q.data) == null ? void 0 : K.mobile_images) == null ? void 0 : X.length,
                    window.innerWidth > 768 ? i.value = o + 1 : i.value = _;
                const y = (ae = (ne = g == null ? void 0 : g.value) == null ? void 0 : ne.data) == null ? void 0 : ae.desktop_images
                    ...
                    , d = y.reduce( (N, J, U) => (J.starting_point && N.push(U),
                    N), [])
                    , x = v.reduce( (N, J, U) => (J.starting_point && N.push(U),
                    N), []);
                n.value = d[Math.floor(Math.random() * d.length)],
                    r.value = x[Math.floor(Math.random() * x.length)],
                    window.innerWidth > 767 ? Y(n.value) : Y(r.value),
                    me()
            }
        );
        const R = () => {
                window.dispatchEvent(new Event("resize")),
                    ...
                    h.to([".custom__cursor", ".custom__cursor--img"], {
                        opacity: 1,
                        duration: 1.5,
                        ease: "expo.inOut"
                    }, 0)
                ...
                if (y.preloaded !== !0) {
                    if (y.media.url)
                        if (y.media.kind === "image") {
                            ...
                            B(y),
                                D.incrementImagesLoaded();
                    else if (y.media_background && y.media_background.url) {
                        const v = new Image;
                        v.src = y.media_background.url,
                            v.onload = () => {
                                D.incrementImagesLoaded()
                            }
                            ,
            ...
            , C = M(null)
            , ee = y => {
                y.target.classList.contains("next__zone") ? C.value = !0 : C.value = !1,
                    ce(),
                    b.currentTime = 0,
                    b.volume = .5,
                    O.currentTime = 0,
                ...
                t && clearTimeout(t),
                    ...
                    C.value === !0 ? i.value < 2 ? window.innerWidth > 768 ? i.value = o : i.value = _ : (window.innerWidth < 768 && u.value === !0 || window.innerWidth > 768) && i.value-- : (i.value > _ - 1 && (i.value = 0),
                        i.value++);
                let v;
                window.innerWidth > 768 ? v = (o - i.value) / o * c.value : v = (_ - i.value) / _ * c.value,
                    T.value = v,
                    w.to(f.value, {
                        y: v,
                        overwrite: !0,
            ...
            , _e = y => {
                ...
                if (!g.value.data.desktop_images[n.value].media.url)
                    return;
                let d;
                if (v.kind === "image")
                    ...
                    d = document.createElement("video"),
                        d.setAttribute("autoplay", !0),
                        d.setAttribute("loop", !0),
                    ...
                    if (k.test(x.src))
                        x.type = "video/mp4";
                    else if (L.test(x.src))
                        x.type = "video/webm";
                    else
                        return;
                    d.appendChild(x)
                }
                d.classList.add("new-element"),
                    l.value.appendChild(d),
                    v.width > v.height && v.width > window.innerWidth ? w.set(d, {
                    ...
                    w.set(d, {
                        x: y.x - d.offsetWidth / 2,
                        y: y.y - d.offsetHeight / 2
                    }),
                    w.set(d, {
                        scale: 0,
                        opacity: 0
            ...
            , j = () => {
                ...
                if (v.classList.add("new-element-container"),
                    g.value.data.mobile_images[r.value].media.url) {
                    let d;
                    const x = g.value.data.mobile_images[r.value].media;
                    x.kind === "image" ? d = document.createElement("img") : (d = document.createElement("video"),
                        d.setAttribute("autoplay", !0),
                        d.setAttribute("loop", !0),
                        d.setAttribute("playsinline", !0),
                        d.muted = !0,
                ...
                if (g.value.data.mobile_images[r.value].media_background) {
                    ...
                    x.kind === "image" ? d = document.createElement("img") : (d = document.createElement("video"),
                        ...
                        d.setAttribute("muted", "")),
                        d.src = x.url,
                        d.classList.add("new-element-background"),
                        v.appendChild(d),
                        l.value.appendChild(v)
                }
                y === !1 ? (w.to(v, {
                    scale: 1.03,
                    opacity: 1,
            ...
            , me = () => {
                l.value.addEventListener("click", ee),
                    window.addEventListener("resize", te)
            }
        ;
        return Ae( () => {
                pe(),
                    l.value.removeEventListener("click", ee),
