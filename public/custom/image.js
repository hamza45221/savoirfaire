    ...
    var initCustomerList = function () {
        ...
        datatable = $(table).DataTable({
            ...
            'columnDefs': [
                ...
                { orderable: false, targets: -1,className:'text-end' }, // Disable ordering on column 6 (actions)
            ...
            Swal.fire({
                ...
                if (result.value) {
                    Swal.fire({
                        ...
                        console.log('ID',ids);
                        console.log('ID',$(deleteSelected).attr('data-url'));
                        $.ajax({
                            url:$(deleteSelected).attr('data-url'),
                            type:'GET',
                            data:{id:ids},
                            success:function(data){
                                console.log(data);
